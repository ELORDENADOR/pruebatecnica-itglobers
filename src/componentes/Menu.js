        ...
        <div id="contenedorMenuInfPC">
          <div id="imgOpcMenuPUFIPUFFInfPC">
            ...
            <div className="textoImgMneuInfPC">
              <a className="textColorMenuInfPC" href="#pufipuff">
                PUFI PUFF
              </a>
            </div>
          </div>
          ...
          <div id="imgOpcMenuPUFIRAINInfPC">
            ...
            <div className="textoImgMneuInfPC">
              <a className="textColorMenuInfPC" href="#pufirain">
                {" "}
                PUFI RAIN{" "}
              </a>
            </div>
          ...
          <div>
            ...
            <div className="textoImgMneuInfPC">
              <a className="textColorMenuInfPC" href="#puficart">
                PUFI CART
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="textoImgMneuInfPC">
              <a className="textColorMenuInfPC" href="#pufinap">
                {" "}
                PUFI NAP
              </a>
            </div>
